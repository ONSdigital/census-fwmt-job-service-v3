...
public class GatewayEventsConfig {
  ...
  public static final String CREATE_SWITCH_REQUEST_RECEIVED = "CREATE_SWITCH_REQUEST_RECEIVED";
  ...
  public GatewayEventManager gatewayEventManager() {
    ...
    gatewayEventManager.addEventTypes(new String[] {
        ...
        RABBIT_QUEUE_UP,
        // from the rm adapter
        RM_CREATE_REQUEST_RECEIVED, CREATE_SWITCH_REQUEST_RECEIVED, RM_UPDATE_REQUEST_RECEIVED,
