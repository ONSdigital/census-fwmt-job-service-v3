...
public class InboundProcessorConfig {
    ...
    public Map<ProcessorKey, List<InboundProcessor<FwmtActionInstruction>>> buildCreateProcessorMap(@Qualifier("Create") List<InboundProcessor<FwmtActionInstruction>> processors){
    ...
    public Map<ProcessorKey, List<InboundProcessor<FwmtActionInstruction>>> buildUpdateProcessorMap(@Qualifier("Update") List<InboundProcessor<FwmtActionInstruction>> processors){
    ...
    public Map<ProcessorKey, List<InboundProcessor<FwmtCancelActionInstruction>>> buildCancelProcessorMap(@Qualifier("Cancel") List<InboundProcessor<FwmtCancelActionInstruction>> processors){
