...
public class ProcessorKey {
        ...
        public static ProcessorKey buildKey(FwmtCancelActionInstruction rmRequest) {
                return ProcessorKey.builder().actionInstruction(rmRequest.getActionInstruction().toString())
                                .surveyName(rmRequest.getSurveyName()).addressType(rmRequest.getAddressType())
