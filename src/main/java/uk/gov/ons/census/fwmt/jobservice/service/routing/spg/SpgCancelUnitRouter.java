...
@Service
public class SpgCancelUnitRouter implements Router<FwmtCancelActionInstruction, ResponseEntity<Void>> {
  private final CometRestClient cometRestClient;

  public SpgCancelUnitRouter(CometRestClient cometRestClient) {
    this.cometRestClient = cometRestClient;
  }

  @Override
  public ResponseEntity<Void> routeUnsafe(FwmtCancelActionInstruction ffu, GatewayCache cache) throws GatewayException {
    return cometRestClient.sendClose(ffu.getCaseId());
  }
