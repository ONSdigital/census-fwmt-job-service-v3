...
@Component
public class SpgCancelUnitRouter implements SPGCancelRouter {
  ...
  public SpgCancelUnitRouter(CometRestClient cometRestClient, GatewayEventManager eventManager, RoutingValidator routingValidator) {
  ...
  public void route(FieldworkFollowup ffu, GatewayCache cache) throws GatewayException {
    ...
    ResponseEntity<Void> response = cometRestClient.sendClose(ffu.getCaseId());
